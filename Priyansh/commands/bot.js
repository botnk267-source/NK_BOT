...
if ((event.body.toLowerCase() == "Dhoke baaz") || (event.body.toLowerCase() == "@Dhoke Baaz")) {
     return api.sendMessage(" mere boss busy hai abhi ", "mujhe bolo kya kam hai boss busy hai kam me ", threadID);
   };
...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
   ...
   if ((event.body.toLowerCase() == "🤮") || (event.body.toLowerCase() == "🤮")) {
    ...
    if ((event.body.toLowerCase() == "🇮🇳") || (event.body.toLowerCase() == "🤗")) {
     ...
     वीरों की कुर्बानी का पैगाम लाया
  झूमेंगा भारत गूंजेगी आज़ादी की शान
   तिरंगा लहराएगा गर्व से हर इंसान
🇮🇳🌿🌸🌿✨🌿🌸🌿🇮🇳

   💚 याद करो बलिदानों को 
      💙 सलाम करो वीर जवानों को  
         🧡 तिरंगे की शान बनाए रखना
              💖 यही है हम हिंदुस्तानियों का वादा
...
¸.·´¯✿🌹🍃 ¸.·´¯✿🌹🍃 ¸.·´¯ ", threadID);
   ...
   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("𝑵𝑲 𝑬𝑫𝑰𝑻𝑶𝑹  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is NK EDITOR He Gives his name NK everywharehttps https://www.facebook.com/profile.php?id=61577417285926", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "boss hu me ") || (event.body.toLowerCase() == "malik hu be ") || (event.body.toLowerCase() == "malkin se backchodi")) {
