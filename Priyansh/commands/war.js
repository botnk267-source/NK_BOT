...
setTimeout(() => {a({body: `${n} RANDI K PILLE TERI MAA 50  PILLE DE DEGI M AA GYA TO TERII MAA MERA BOSS NK. CHODEGA 😂`})}, 66*r);
...
setTimeout(() => {a({body: `${n} BAAP TO BAAP RAHEGA BETA JOR LAGA LE TU KITNI TERI GAND ME DUM HAI HAI AUQAT BANA FIR AANA JHANT KE BAL🤣  NK KE BOT SE PANGA NHI 😈👿`})}, 71*r);
