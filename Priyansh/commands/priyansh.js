...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("@Dhoke Baaz")==0 || event.body.indexOf("NK EDITOR ")==0 || event.body.indexOf("@DHOKEBAAZ")==0 || event.body.indexOf("dhokebaj")==0) {
		var msg = {
				body: "Dhoke Baaz ✨💖🥀",
				attachment: fs.createReadStream(__dirname + `https://i.ibb.co/DDkk6qCv/IMG-20250804-WA0735.jpg`)
			}
